...
describe("parseFilesFromMessage", () => {
  describe("oliveagent-read tags", () => {
    it("should parse a single oliveagent-read tag", () => {
      const input = '<oliveagent-read path="src/components/Button.tsx"></oliveagent-read>';
      const result = parseFilesFromMessage(input);
      expect(result).toEqual(["src/components/Button.tsx"]);
    });

    it("should parse multiple oliveagent-read tags", () => {
      const input = `
        <oliveagent-read path="src/components/Button.tsx"></oliveagent-read>
        <oliveagent-read path="src/utils/helpers.ts"></oliveagent-read>
        <oliveagent-read path="src/styles/main.css"></oliveagent-read>
      `;
      const result = parseFilesFromMessage(input);
    ...
    it("should trim whitespace from file paths in oliveagent-read tags", () => {
      const input =
        '<oliveagent-read path="  src/components/Button.tsx  "></oliveagent-read>';
      const result = parseFilesFromMessage(input);
      expect(result).toEqual(["src/components/Button.tsx"]);
    ...
    it("should skip empty path attributes", () => {
      const input = `
        <oliveagent-read path="src/components/Button.tsx"></oliveagent-read>
        <oliveagent-read path=""></oliveagent-read>
        <oliveagent-read path="src/utils/helpers.ts"></oliveagent-read>
      `;
      const result = parseFilesFromMessage(input);
      expect(result).toEqual([
    ...
    it("should handle file paths with special characters", () => {
      const input =
        '<oliveagent-read path="src/components/@special/Button-v2.tsx"></oliveagent-read>';
      const result = parseFilesFromMessage(input);
      expect(result).toEqual(["src/components/@special/Button-v2.tsx"]);
    });
  });

  describe("oliveagent-code-search-result tags", () => {
    it("should parse a single file from oliveagent-code-search-result", () => {
      const input = `<oliveagent-code-search-result>
src/components/Button.tsx
    ...
    it("should parse multiple files from oliveagent-code-search-result", () => {
      const input = `<oliveagent-code-search-result>
src/components/Button.tsx
...
src/utils/helpers.ts
    ...
    it("should skip empty lines in oliveagent-code-search-result", () => {
      const input = `<oliveagent-code-search-result>
src/components/Button.tsx
...
src/utils/helpers.ts
    ...
    it("should handle multiple oliveagent-code-search-result tags", () => {
      const input = `<oliveagent-code-search-result>
src/components/Button.tsx
src/components/Input.tsx
</oliveagent-code-search-result>
...
src/styles/main.css
  ...
  describe("mixed tags", () => {
    it("should parse both oliveagent-read and oliveagent-code-search-result tags", () => {
      const input = `
<oliveagent-read path="src/config/app.ts"></oliveagent-read>
...
<oliveagent-read path="src/components/Header.tsx"></oliveagent-read>
...
<oliveagent-read path="src/config/site.ts"></oliveagent-read>
...
`;
  ...
  describe("edge cases", () => {
    ...
    it("should handle malformed tags gracefully", () => {
      const input = `
<oliveagent-read path="src/file1.ts"
<oliveagent-code-search-result>
src/file2.ts
`;
      const result = parseFilesFromMessage(input);
    ...
    it("should handle nested angle brackets in file paths", () => {
      const input =
        '<oliveagent-read path="src/components/Generic<T>.tsx"></oliveagent-read>';
      const result = parseFilesFromMessage(input);
...
SRC/COMPONENTS/BUTTON.TSX
    ...
    it("should handle very long file paths", () => {
      ...
      const input = `<oliveagent-read path="${longPath}"></oliveagent-read>`;
      const result = parseFilesFromMessage(input);
...
describe("processChatMessagesWithVersionedFiles", () => {
  ...
  describe("processing assistant messages", () => {
      ...
      const chatMessages: ModelMessage[] = [
        {
          role: "assistant",
          content:
            'I found this file: <oliveagent-read path="src/old.ts"></oliveagent-read>',
          providerOptions: {
            "oliveagent-engine": {
      ...
      const chatMessages: ModelMessage[] = [
        {
          ...
          content: [
            {
              type: "text",
              text: 'Here is the file: <oliveagent-read path="src/array.ts"></oliveagent-read>',
            },
            {
              type: "text",
      ...
      const chatMessages: ModelMessage[] = [
        {
          role: "user",
          content:
            'Check this: <oliveagent-read path="src/user-file.ts"></oliveagent-read>',
        },
      ];
      const appPath = "/test/app";
    ...
    it("should skip assistant messages without sourceCommitHash", async () => {
      ...
      const chatMessages: ModelMessage[] = [
        {
          role: "assistant",
          content: 'File here: <oliveagent-read path="src/no-commit.ts"></oliveagent-read>',
          // No providerOptions
        },
        {
          role: "assistant",
          content:
            'Another file: <oliveagent-read path="src/no-commit2.ts"></oliveagent-read>',
          providerOptions: {
            // oliveagent-engine not set
          },
        },
      ];
      const appPath = "/test/app";
  ...
  describe("parsing multiple file paths", () => {
    it("should process multiple files from oliveagent-code-search-result", async () => {
      const { getFileAtCommit } = await import("@/ipc/utils/git_utils");
      const mockGetFileAtCommit = vi.mocked(getFileAtCommit);
      ...
      const chatMessages: ModelMessage[] = [
        {
          role: "assistant",
          content: `<oliveagent-code-search-result>
src/file1.ts
src/file2.ts
</oliveagent-code-search-result>`,
          providerOptions: {
    ...
    it("should process mixed oliveagent-read and oliveagent-code-search-result tags", async () => {
      const { getFileAtCommit } = await import("@/ipc/utils/git_utils");
      const mockGetFileAtCommit = vi.mocked(getFileAtCommit);
      ...
      const chatMessages: ModelMessage[] = [
        {
          role: "assistant",
          content: `
<oliveagent-read path="src/file1.ts"></oliveagent-read>
  ...
  describe("error handling", () => {
      ...
      const chatMessages: ModelMessage[] = [
        {
          role: "assistant",
          content:
            'Missing file: <oliveagent-read path="src/missing.ts"></oliveagent-read>',
          providerOptions: {
            "oliveagent-engine": {
              sourceCommitHash: "commit1",
            },
    ...
    it("should handle getFileAtCommit throwing an error", async () => {
      ...
      const chatMessages: ModelMessage[] = [
        {
          role: "assistant",
          content: 'Error file: <oliveagent-read path="src/error.ts"></oliveagent-read>',
          providerOptions: {
            "oliveagent-engine": {
              sourceCommitHash: "commit1",
            },
  ...
  describe("multiple messages", () => {
    it("should process multiple messages with different commits", async () => {
      ...
      const chatMessages: ModelMessage[] = [
        ...
        {
          role: "assistant",
          content: 'Here it is: <oliveagent-read path="src/file1.ts"></oliveagent-read>',
          providerOptions: {
            "oliveagent-engine": {
              sourceCommitHash: "commit1",
            },
        ...
        },
        {
          role: "assistant",
          content:
            'Here it is again: <oliveagent-read path="src/file1.ts"></oliveagent-read>',
          providerOptions: {
            "oliveagent-engine": {
  ...
  describe("integration with files parameter", () => {
    it("should combine files parameter with versioned files from messages", async () => {
      ...
      const chatMessages: ModelMessage[] = [
        {
          role: "assistant",
          content: 'Old version: <oliveagent-read path="src/old.ts"></oliveagent-read>',
          providerOptions: {
            "oliveagent-engine": {
              sourceCommitHash: "abc123",
            },
