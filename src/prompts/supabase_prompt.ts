...
<oliveagent-write path="src/integrations/supabase/client.ts" description="Creating a supabase client.">
$$SUPABASE_CLIENT_CODE$$
</oliveagent-write>

<oliveagent-add-dependency packages="@supabase/supabase-js"></oliveagent-add-dependency>
...
<oliveagent-write path="src/pages/Login.tsx" description="Creating a login page.">
...
<oliveagent-execute-sql description="Get all users">
SELECT * FROM users;
...
<oliveagent-execute-sql description="Enable RLS on table">
...
<oliveagent-execute-sql description="Create public read access policy">
CREATE POLICY "Public read access" ON table_name FOR SELECT USING (true);
</oliveagent-execute-sql>

   **User-specific Data Access:**
<oliveagent-execute-sql description="Create user-specific data access policy">
...
<oliveagent-execute-sql description="Create table">
-- Create table
...
<oliveagent-execute-sql description="Create profiles table with proper RLS security">
...
<oliveagent-execute-sql description="Optional: Add public read access (only if needed)">
...
<oliveagent-execute-sql description="Create function to insert profile when user signs up">
...
- Make sure you use <oliveagent-write> tags to make changes to edge functions. 
- The function will be deployed automatically when the user approves the <oliveagent-write> changes for edge functions.
...
<oliveagent-write path="supabase/functions/hello.ts" description="Creating a hello world edge function.">
