...
export const TURBO_EDITS_PROMO_MESSAGE: MessageConfig = {
  spans: [
    ...
    { type: "link", content: " Get OliveAgent Pro", url: "https://oliveagent.sh/pro#ai" },
...
export const SMART_CONTEXT_PROMO_MESSAGE: MessageConfig = {
  spans: [
    ...
    {
      type: "link",
      content: "OliveAgent Pro's Smart Context",
      url: "https://oliveagent.sh/pro#ai",
    },
  ],
};
...
export const REDDIT_TIP: MessageConfig = {
  spans: [
    ...
    {
      type: "link",
      content: "OliveAgent subreddit",
      url: "https://www.reddit.com/r/oliveagentbuilders/",
    },
  ],
};
...
export const BUILD_A_BIBLE_APP_TIP: MessageConfig = {
  spans: [
    ...
    {
      type: "text",
      content: " the creator of OliveAgent build a Bible app step-by-step",
    },
  ],
};
...
export const DEBUGGING_TIPS_TIP: MessageConfig = {
  spans: [
    ...
    },
    {
      ...
      url: "https://www.oliveagent.sh/docs/guides/debugging",
    },
  ],
};

// Advanced tip: Customize your AI rules https://www.oliveagent.sh/docs/guides/ai-rules
export const AI_RULES_TIP: MessageConfig = {
  spans: [
    ...
    },
    {
      type: "link",
      content: "AI rules",
      url: "https://www.oliveagent.sh/docs/guides/ai-rules",
    },
  ],
};
...
// Want to know what's next? Checkout our roadmap https://www.oliveagent.sh/docs/roadmap
export const ROADMAP_TIP: MessageConfig = {
  spans: [
    ...
    },
    {
      type: "link",
      content: "roadmap",
      url: "https://www.oliveagent.sh/docs/roadmap",
    },
  ],
};

// Like OliveAgent? Star it on GitHub https://github.com/oliveagent-sh/oliveagent/
export const GITHUB_TIP: MessageConfig = {
  spans: [
    {
      type: "text",
      content: "Like OliveAgent? Star it on ",
    },
    {
      type: "link",
      content: "GitHub",
      url: "https://github.com/oliveagent-sh/oliveagent",
    },
  ],
};
