...
export function ManageOliveAgentProButton() {
  return (
    <Button
      variant="outline"
      size="lg"
      ...
      onClick={() => {
        IpcClient.getInstance().openExternalUrl(
          "https://academy.oliveagent.sh/subscription",
        );
      }}
    >
...
export function SetupOliveAgentProButton() {
  return (
    <Button
      variant="outline"
      size="lg"
    ...
    >
      <KeyRound aria-hidden="true" />
      Already have OliveAgent Pro? Add your key
    </Button>
  );
}
...
export function AiAccessBanner() {
  return (
    <div
      ...
      onClick={() => {
        IpcClient.getInstance().openExternalUrl(
          "https://www.oliveagent.sh/pro?utm_source=oliveagent-app&utm_medium=app&utm_campaign=in-app-banner-ai-access",
        );
      }}
    >
      <div
      ...
      <div className="relative z-10 text-center flex flex-col items-center gap-0.5 sm:gap-1 md:gap-1.5 px-4 md:px-6 pr-6 md:pr-8">
        <div className="mt-0.5 sm:mt-1 flex items-center gap-2 sm:gap-3 justify-center">
          ...
          <button
            type="button"
            aria-label="Subscribe to OliveAgent Pro"
...
export function SmartContextBanner() {
  return (
    <div
      ...
      onClick={() => {
        IpcClient.getInstance().openExternalUrl(
          "https://www.oliveagent.sh/pro?utm_source=oliveagent-app&utm_medium=app&utm_campaign=in-app-banner-smart-context",
        );
      }}
    >
      <div
...
export function TurboBanner() {
  return (
    <div
      ...
      onClick={() => {
        IpcClient.getInstance().openExternalUrl(
          "https://www.oliveagent.sh/pro?utm_source=oliveagent-app&utm_medium=app&utm_campaign=in-app-banner-turbo",
        );
      }}
    >
      <div
