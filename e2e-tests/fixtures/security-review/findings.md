...
<oliveagent-security-finding title="Unvalidated File Upload Extensions" level="medium">
...
</oliveagent-security-finding>

<oliveagent-security-finding title="Missing CSRF Protection on State-Changing Operations" level="medium">
...
<oliveagent-security-finding title="SQL Injection in User Lookup" level="critical">
...
<oliveagent-security-finding title="Hardcoded AWS Credentials in Source Code" level="critical">
...
<oliveagent-security-finding title="Missing Authentication on Admin Endpoints" level="high">
...
<oliveagent-security-finding title="JWT Secret Using Default Value" level="high">
...
<oliveagent-security-finding title="Verbose Error Messages Expose Stack Traces" level="low">
...
<oliveagent-security-finding title="Missing Security Headers" level="low">
