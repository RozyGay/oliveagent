...
(async () => {
  const browser = await electron.launch({
    args: [
      "../../out/oliveagent-darwin-arm64/oliveagent.app/Contents/Resources/app.asar/.vite/build/main.js",
      "--enable-logging",
      "--user-data-dir=/tmp/oliveagent-e2e-tests",
    ],
    executablePath: "../../out/oliveagent-darwin-arm64/oliveagent.app/Contents/MacOS/oliveagent",
  });
